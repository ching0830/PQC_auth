...
| 第 4 章 提出之機制 | FAC、PQ-RBBC、opening、satellite access、lifecycle、handover | PQ-RBBC legacy relation／parent join 已有 executable evidence，unified-tree candidate 已至 v2.42 bounded recovery／provenance且technical re-review通過；one-time lifecycle、control plane 與 access wire objects 有 draft／test-only reference | G1 interface freeze 與完整 protocol |
