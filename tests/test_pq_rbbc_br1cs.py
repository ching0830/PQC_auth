...
class BinaryR1CSBackendTests(unittest.TestCase):
    ...
    def test_blind_uov_boundary_remains_explicit(self) -> None:
        ...
        self.assertEqual(contract["production_tree0_producer_max_wire_id"], 79_148_426)
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            backend.native_profile.tree2_rebased_recovery_evidence.FROZEN_EVIDENCE_SHA256,
        )
        ...
        self.assertEqual(
            ...
            backend.native_profile.planned_tree_producer.RELATION_ID,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            backend.native_profile.tree4_planned_recovery_evidence.FROZEN_EVIDENCE_SHA256,
        )
