...
import pq_rbbc_cap_tree8_frozen_replay as frozen
import pq_rbbc_cap_planned_tree_producer as planned


class Tree8FrozenReplayTests(unittest.TestCase):
    def test_frozen_contract_uses_tree8_observation(self) -> None:
        contract = frozen.frozen_contract()
        self.assertEqual(contract.tree_index, 8)
