...
def build_manifest(full_negative_circuits: bool = False) -> dict[str, object]:
    ...
    return {
        ...
        "claim_boundary": {
            ...
            "forked_issuance": "the production reference, namespace, tree-2 planned-offset gate, and checkpointable recovery path are frozen; the v2.8 execution cache and v2.9 global-tail archive have been regenerated and revalidated, and tree 2 has been fully replayed at its planned offset, while the remaining producers, complete replay, and parent join remain open",
