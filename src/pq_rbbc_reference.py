...
def build_manifest(full_negative_circuits: bool = False) -> dict[str, object]:
    ...
    return {
        ...
        "claim_boundary": {
            ...
            "forked_issuance": "the production reference, namespace, checkpointable generic planned-offset runner, and recovery path are frozen; the v2.8 execution cache and v2.9 global-tail archive have been regenerated and revalidated, and planned trees 0, 1, and 2 have been materialized, with trees 1 and 2 fully replayed at their planned offsets, while the remaining producers, complete replay, and parent join remain open",
