...
def build_manifest(full_negative_circuits: bool = False) -> dict[str, object]:
    ...
    return {
        ...
        "claim_boundary": {
            ...
            "forked_issuance": "the production reference, namespace, checkpointable generic planned-offset runner, and recovery path are frozen; the v2.8 execution cache and v2.9 global-tail archive have been regenerated and revalidated, and planned trees 0 through 3 have been materialized, with trees 1, 2, and 3 fully replayed at their planned offsets, while the remaining producers, complete replay, and parent join remain open",
        ...
        "native_import_contract": {
            ...
            "production_tree2_rebased_recovery_evidence_relation_id": native_profile.tree2_rebased_recovery_evidence.RELATION_ID,
            "production_tree2_rebased_recovery_evidence_sha256": native_profile.tree2_rebased_recovery_evidence.FROZEN_EVIDENCE_SHA256,
            "production_tree2_rebased_replayed_manifest_sha256": native_profile.tree2_rebased_recovery_evidence.FROZEN_REPLAY_MANIFEST_SHA256,
            "production_tree2_rebased_production_rows_replayed": native_profile.tree2_rebased_recovery_evidence.FROZEN_ROWS,
            "production_tree2_rebased_assignment_sha256": native_profile.tree2_rebased_recovery_evidence.FROZEN_ARCHIVE_SHA256,
            "production_tree2_rebased_row_stream_sha256": native_profile.tree2_rebased_recovery_evidence.FROZEN_STREAM_SHA256,
            "planned_tree_runner_relation_id": native_profile.planned_tree_producer.RELATION_ID,
            "production_tree1_planned_contract_sha256": native_profile.planned_tree_producer.FROZEN_TREE1_CONTRACT_SHA256,
            "production_tree1_planned_local_wire_start": native_profile.TREE1_PLANNED_CONTRACT.planned_local_wire_start,
            "production_tree1_planned_max_wire_id": native_profile.TREE1_PLANNED_CONTRACT.planned_max_wire_id,
            "production_tree1_planned_output_wire_starts": native_profile.TREE1_PLANNED_CONTRACT.planned_output_wire_starts,
            "production_tree1_planned_recovery_evidence_relation_id": native_profile.tree1_planned_recovery_evidence.RELATION_ID,
            "production_tree1_planned_recovery_evidence_sha256": native_profile.tree1_planned_recovery_evidence.FROZEN_EVIDENCE_SHA256,
            "production_tree1_planned_replayed_manifest_sha256": native_profile.tree1_planned_recovery_evidence.FROZEN_REPLAY_MANIFEST_SHA256,
            "production_tree1_planned_rows_replayed": native_profile.tree1_planned_recovery_evidence.FROZEN_ROWS,
            "production_tree1_planned_local_wires": native_profile.tree1_planned_recovery_evidence.FROZEN_WIRES,
            "production_tree1_planned_assignment_sha256": native_profile.tree1_planned_recovery_evidence.FROZEN_ARCHIVE_SHA256,
            "production_tree1_planned_assignment_body_sha256": native_profile.tree1_planned_recovery_evidence.FROZEN_BODY_SHA256,
            "production_tree1_planned_row_stream_bytes": native_profile.tree1_planned_recovery_evidence.FROZEN_STREAM_BYTES,
            "production_tree1_planned_row_stream_sha256": native_profile.tree1_planned_recovery_evidence.FROZEN_STREAM_SHA256,
            "production_tree1_planned_tree_component_sha256": native_profile.tree1_planned_recovery_evidence.FROZEN_TREE_COMPONENT_SHA256,
            "production_tree3_planned_contract_sha256": native_profile.planned_tree_producer.FROZEN_TREE3_CONTRACT_SHA256,
            "production_tree3_planned_local_wire_start": native_profile.TREE3_PLANNED_CONTRACT.planned_local_wire_start,
            "production_tree3_planned_max_wire_id": native_profile.TREE3_PLANNED_CONTRACT.planned_max_wire_id,
            "production_tree3_planned_output_wire_starts": native_profile.TREE3_PLANNED_CONTRACT.planned_output_wire_starts,
            "production_tree3_planned_recovery_evidence_relation_id": native_profile.tree3_planned_recovery_evidence.RELATION_ID,
            "production_tree3_planned_recovery_evidence_sha256": native_profile.tree3_planned_recovery_evidence.FROZEN_EVIDENCE_SHA256,
            "production_tree3_planned_replayed_manifest_sha256": native_profile.tree3_planned_recovery_evidence.FROZEN_REPLAY_MANIFEST_SHA256,
            "production_tree3_planned_rows_replayed": native_profile.tree3_planned_recovery_evidence.FROZEN_ROWS,
            "production_tree3_planned_local_wires": native_profile.tree3_planned_recovery_evidence.FROZEN_WIRES,
            "production_tree3_planned_assignment_sha256": native_profile.tree3_planned_recovery_evidence.FROZEN_ARCHIVE_SHA256,
            "production_tree3_planned_assignment_body_sha256": native_profile.tree3_planned_recovery_evidence.FROZEN_BODY_SHA256,
            "production_tree3_planned_row_stream_bytes": native_profile.tree3_planned_recovery_evidence.FROZEN_STREAM_BYTES,
            "production_tree3_planned_row_stream_sha256": native_profile.tree3_planned_recovery_evidence.FROZEN_STREAM_SHA256,
            "production_tree3_planned_tree_component_sha256": native_profile.tree3_planned_recovery_evidence.FROZEN_TREE_COMPONENT_SHA256,
            "production_tree4_planned_contract_sha256": native_profile.planned_tree_producer.FROZEN_TREE4_CONTRACT_SHA256,
            "production_tree4_planned_local_wire_start": native_profile.TREE4_PLANNED_CONTRACT.planned_local_wire_start,
            "production_tree4_planned_max_wire_id": native_profile.TREE4_PLANNED_CONTRACT.planned_max_wire_id,
            "production_tree4_planned_output_wire_starts": native_profile.TREE4_PLANNED_CONTRACT.planned_output_wire_starts,
            "production_tree4_planned_recovery_evidence_relation_id": native_profile.tree4_planned_recovery_evidence.RELATION_ID,
            "production_tree4_planned_recovery_evidence_sha256": native_profile.tree4_planned_recovery_evidence.FROZEN_EVIDENCE_SHA256,
            "production_tree4_planned_replayed_manifest_sha256": native_profile.tree4_planned_recovery_evidence.FROZEN_REPLAY_MANIFEST_SHA256,
            "production_tree4_planned_rows_replayed": native_profile.tree4_planned_recovery_evidence.FROZEN_ROWS,
            "production_tree4_planned_local_wires": native_profile.tree4_planned_recovery_evidence.FROZEN_WIRES,
            "production_tree4_planned_assignment_sha256": native_profile.tree4_planned_recovery_evidence.FROZEN_ARCHIVE_SHA256,
            "production_tree4_planned_assignment_body_sha256": native_profile.tree4_planned_recovery_evidence.FROZEN_BODY_SHA256,
