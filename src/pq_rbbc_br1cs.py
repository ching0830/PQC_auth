...
def build_backend_manifest(output_path: str | os.PathLike[str]) -> dict[str, object]:
    ...
    return {
        ...
        "status": "the checkpointable recovery path has regenerated and revalidated the frozen v2.8 execution cache and v2.9 global-tail archive; planned trees 0, 1, and 2 are materialized, and trees 1 and 2 have been fully replayed at their planned offsets; the remaining producers, complete replay, cross-segment identity, and parent join remain external",
        "format": {
