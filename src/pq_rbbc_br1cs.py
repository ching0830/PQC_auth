...
def build_backend_manifest(output_path: str | os.PathLike[str]) -> dict[str, object]:
    ...
    return {
        ...
        "status": "the checkpointable recovery path has regenerated and revalidated the frozen v2.8 execution cache and v2.9 global-tail archive, and tree 2 has been fully replayed at its planned offset; the remaining producers, complete replay, cross-segment identity, and parent join remain external",
        "format": {
